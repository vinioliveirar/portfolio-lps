(function ($) {
  ...
  function toggleMobileMenu() {
    ...
    $(".responsive-menu .slicknav_menu").toggleClass("active");
    $("#mobileMenuClose").toggleClass("show");
  ...
  function closeMobileMenu() {
    ...
    $(".responsive-menu .slicknav_menu").removeClass("active");
    $("#mobileMenuClose").removeClass("show");
  ...
  $(document).on("click", function (e) {
    if ($("body").hasClass("menu-open")) {
      if (!$(e.target).closest(".navbar-toggler, .responsive-menu, .mobile-menu-close, .slicknav_menu").length) {
        closeMobileMenu();
      }
    }
  });

  // Ensure menu links work after SlickNav initialization
  setTimeout(function () {
  ...
  if (element.hasClass("interactive-process-layout")) {
    ...
    element.find(".interactive-process-image").each(function () {
  ...
  if ($feature_item_list.length) {
    var $feature_item = $feature_item_list.find(".features-item");
  ...
  $(document).on("click", 'a[href^="#"]', function (e) {
    ...
    // Skip empty anchors and social media links
    ...
    if (target.length) {
      ...
      if ($("body").hasClass("menu-open") || $(".responsive-menu").hasClass("active")) {
        closeMobileMenu();
      }
